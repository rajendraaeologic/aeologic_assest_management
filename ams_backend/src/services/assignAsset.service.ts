...
//     }
//
//     // If changing asset, verify new asset exists and is available
...
//         }
//
//         if (asset.status !== AssetStatus.ACTIVE && asset.status !== AssetStatus.IN_USE) {
//             throw new ApiError(
//                 httpStatus.BAD_REQUEST,
//                 `Asset is not available for assignment (current status: ${asset.status})`
//             );
...
//             },
//         }),
//         // If asset was changed, update the old and new asset statuses
//         ...(updateData.assetId ? [
//             db.asset.update({
...
//             })
//         ] : []),
//         // If user was changed but asset stays the same, update asset's assigned user
//         ...(updateData.userId && !updateData.assetId ? [
//             db.asset.update({
//                 where: { id: existingAssignment.assetId },
//                 data: {
