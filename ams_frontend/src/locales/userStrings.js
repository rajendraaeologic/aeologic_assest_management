const userStrings = {
  ...
  addUser: {
    ...
    validation: {
      ...
      userNameMaxLength: "User Name  must be at most 25 characters ",
      phoneRequired: "Contact number is required",
      phoneMinLength: "Phone   must be 10 Digits ",
      phoneMaxLength: "Phone  must be at most 10 Digits ",
      ...
      userNamePattern: "Username must contain only  characters",
  ...
  updateUser: {
    ...
    validation: {
      ...
      phoneMaxLength: "Phone  must be at most 10 Numbers ",
