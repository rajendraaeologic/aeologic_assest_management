        ...
        <div className="pt-24">
          <div className="flex justify-between mx-5 mt-2">
            ...
            <div
              className={`${
                isSidebarOpen
                  ? "flex flex-col md:flex-row justify-center items-center gap-3 md:mr-2 lg:mr-8"
                  : "flex flex-col md:flex-row justify-center items-center gap-3 md:mr-8"
              }`}
            >
              <div>
                <input type="date" />
          ...
          <div className="mx-5 flex gap-2 mb-4">
            ...
            <p className="text-[#6c757D]">Date Range Report</p>
          </div>
        </div>
