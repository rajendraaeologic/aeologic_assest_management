...
const TrackDeviceReport = () => {
  ...
  // Handle changes for search fields dynamically
      ...
      setUsers([
        {
          ...
          assettype: "Phone",
          make: "Mediatek",
          assetdetails: "LIBER_MTK45",
          model: "SMT3",
          mtkassetcode: "MTK-M-8032",
          hardwaretype: "Camera",
          status: "inventory",
          assetstatus: "	working",
          assignedto: "kite",
      ...
      >
        <div className="pt-24">
          ...
          <div className="mx-5 flex gap-2 mb-4">
            ...
            <p className="text-[#6c757D]"> Track Device Report</p>
          </div>
        </div>
...
export default TrackDeviceReport;
